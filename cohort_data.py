def unique_houses(filename):
    ...
    for lines in cohort_data:
        clean_data = lines.rstrip()
        final_data = clean_data.split("|")
        #get rid of empty element (' ') in houses list with if/else statement before appending onto houses list
        house.append(final_data[2])
